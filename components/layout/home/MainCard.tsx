...
const MainCard = () => {
	return (
		<Card className='dark:bg-hero bg-gradient-to-tr from-default to-background bg-cover bg-right-top lg:h-full h-auto flex lg:flex-row flex-col-reverse items-center justify-center px-4 lg:px-8 py-12 rounded-lg'>
			{/* Text */}
